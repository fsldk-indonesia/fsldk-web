...
export const FIELD_TYPES: FieldTypeMeta[] = [
  { value: 'short_text', label: 'Teks Singkat', icon: 'font', group: 'Teks' },
  { value: 'long_text', label: 'Paragraf', icon: 'align-left', group: 'Teks' },
  { value: 'email', label: 'Email', icon: 'mail', group: 'Teks' },
  { value: 'number', label: 'Angka', icon: 'hash', group: 'Teks' },
  { value: 'phone', label: 'Nomor Telepon', icon: 'phone', group: 'Teks' },
  { value: 'url', label: 'Tautan (URL)', icon: 'link', group: 'Teks' },
  { value: 'date', label: 'Tanggal', icon: 'calendar', group: 'Tanggal & Waktu' },
  { value: 'time', label: 'Waktu', icon: 'clock', group: 'Tanggal & Waktu' },
  { value: 'datetime', label: 'Tanggal & Waktu', icon: 'calendar', group: 'Tanggal & Waktu' },
  { value: 'dropdown', label: 'Dropdown', icon: 'chevron-down', group: 'Pilihan' },
  { value: 'radio', label: 'Pilihan Ganda', icon: 'circle-dot', group: 'Pilihan' },
  { value: 'checkbox', label: 'Kotak Centang', icon: 'square-check', group: 'Pilihan' },
  { value: 'linear_scale', label: 'Skala Linear', icon: 'sliders', group: 'Pilihan' },
  { value: 'rating', label: 'Rating Bintang', icon: 'star', group: 'Pilihan' },
  { value: 'file', label: 'Unggah Berkas', icon: 'upload', group: 'Unggahan' },
  { value: 'paragraph', label: 'Teks Statis', icon: 'paragraph', group: 'Tampilan' },
  { value: 'image', label: 'Gambar', icon: 'image', group: 'Tampilan' },
  { value: 'video', label: 'Video', icon: 'video', group: 'Tampilan' },
