...
import { QR_PREVIEW_EXAMPLE_URL } from '../../qrcode-preview';
 ...
 * dipasang di bawah PublicLayoutComponent dengan path statis
 * (`qrcode/ajukan`). Pola identik dengan halaman pengajuan shortlink.
 */
@Component({
  selector: 'app-qrcoderequest-submit-page',
  standalone: true,
  templateUrl: './qrcoderequest.submit.page.html',
  imports: [FormsModule, RouterLink, IconComponent, QrcodeStyleEditorComponent],
