...
export class QRCodeRequestIndexPage implements OnInit, QRCodeRequestIndexView {
  ...
  openReject(r: QRCodeRequest): void {
    this.rejectTarget = r;
    this.rejectReason = '';
  ...
  setRequests(items: QRCodeRequest[], count: number): void { this.requests.set(items); this.count.set(count); this.loading.set(false); }
